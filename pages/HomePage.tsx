...
{/* INNOVACIONES - PANEL DESLIZANTE */}
      <section className="animate-fadeIn">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory pb-4 hide-scrollbar">
          ...
          {/* SLIDE 1: TOKEN $HUARAZ (Tu código original exacto) */}
          <div className="w-full shrink-0 snap-center px-1">
            <div className="bg-[#0A0A0A] rounded-[3.5rem] p-10 shadow-2xl text-white overflow-hidden relative border border-[#39FF14]/30">
              <div 
          ...
          <div className="w-full shrink-0 snap-center px-1">
            <div className="bg-[#0A0A0A] rounded-[3.5rem] p-10 shadow-2xl text-white overflow-hidden relative border border-[#FFD700]/30">
              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-10">
                  <div className="flex items-center gap-5">
                    <div className="w-20 h-20 bg-[#FFD700] rounded-3xl flex items-center justify-center text-black font-black text-3xl shadow-[0_0_30px_rgba(255,215,0,0.6)]">VX</div>
                    <div>
                      <div className="bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-xl inline-flex items-center gap-2 mb-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#FFD700] animate-pulse"></span>
                        <p className="text-[10px] font-black tracking-[0.2em] text-white/80 uppercase">360° ENGINE</p>
                      </div>
                      <h3 className="text-4xl font-black tracking-tighter italic uppercase">VIDRYX</h3>
                    </div>
                  </div>
                  <div className="text-left md:text-right">
                     <p className="text-[10px] text-white/40 uppercase font-black tracking-[0.3em] mb-2">{t('Vistas Mensuales', 'Monthly Views')}</p>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 mb-10">
                    <div className="flex justify-between items-center mb-6">
                        <p className="text-[10px] font-black text-white/50 uppercase tracking-widest">Exploraciones Activas (24h)</p>
                        <p className="text-2xl font-black text-white italic">+342 <i className="fas fa-caret-up text-[#FFD700] ml-2"></i></p>
                    </div>
                    <div className="h-32 w-full flex items-end">
                        <svg viewBox="0 0 100 40" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                            <path d="M0,35 Q15,30 25,20 T45,28 T65,15 T85,18 T100,5" fill="none" stroke="#FFD700" strokeWidth="3" strokeLinecap="round" className="drop-shadow-[0_0_10px_rgba(255,215,0,0.8)]" />
                            <path d="M0,35 Q15,30 25,20 T45,28 T65,15 T85,18 T100,5 L100,40 L0,40 Z" fill="url(#goldGradient)" opacity="0.3" />
                ...
                <button onClick={() => navigate('/inmersivo')} className="w-full bg-[#FFD700] text-black py-6 rounded-[2rem] font-black uppercase text-xs tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-white transition-all shadow-[0_15px_40px_rgba(255,215,0,0.3)]">
                    {t('Explorar en 360°', 'Explore in 360°')} <i className="fas fa-vr-cardboard"></i>
                </button>
              </div>
            </div>
          </div>
