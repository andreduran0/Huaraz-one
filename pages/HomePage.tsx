     ...
     {/* INNOVACIONES - PANEL DESLIZANTE CON AUTOPLAY Y PUNTOS */}
      <section className="animate-fadeIn relative px-2">
        ...
        >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-4">
                  ...
                  <div className="text-left md:text-right mt-1 md:mt-0">
                     ...
                     <p className="text-3xl font-black tracking-tighter italic text-[#39FF14] drop-shadow-[0_0_15px_rgba(57,255,20,0.6)]">$424.8K</p>
                  </div>
                </div>
          ...
          </div> {/* SLIDE NUEVO: EXPANSIÓN HOTELES Y AGENCIAS */}
          <div className="w-full shrink-0 snap-center px-1 flex">
            <div className="w-full bg-[#0A0A0A] rounded-[2.5rem] p-5 md:p-7 shadow-2xl text-white overflow-hidden relative border border-[#00E5FF]/30 flex flex-col">
              ...
              <div 
                ...
                style={{ backgroundImage: "url('https://i.imgur.com/VGCy5hG.jpeg')" }} 
              ></div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="bg-black/40 backdrop-blur-md border border-white/20 px-3 py-0.5 rounded-lg inline-flex items-center gap-1.5 mb-1">
                        ...
                        <p className="text-[8px] font-black tracking-[0.2em] text-white/90 uppercase">IMPLEMENTANDO</p>
                      </div>
