...
<button 
    ...
    className="bg-[#2A4D69] text-white w-full px-10 md:px-14 py-6 md:py-8 rounded-[2rem] font-black uppercase text-[10px] md:text-xs tracking-[0.3em] shadow-2xl flex items-center justify-center gap-4 active:scale-95 transition-all"
>
                ...
                <div className="fixed inset-0 z-[200] bg-slate-950/98 flex flex-col animate-fadeIn">
                    <div className="p-8 flex items-center justify-between text-white border-b border-white/5 bg-black/20 backdrop-blur-xl">
                        ...
                        <button
                            ...
                            className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-all active:scale-90 z-[300]"
                        >
                    ...
                    <div className="flex-grow relative flex items-center justify-center p-4 md:p-12 overflow-hidden">
                        ...
                        {/* 👇 AQUI ESTÁ EL NUEVO COMPONENTE DE ZOOM 👇 */}
                        <TransformWrapper initialScale={1} minScale={1} maxScale={10}>
                            <TransformComponent wrapperStyle={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                <img 
                                    ...
                                    className="max-w-full max-h-[85vh] object-contain rounded-xl shadow-[0_0_150px_rgba(0,0,0,0.8)] border border-white/5 cursor-zoom-in" 
                                    alt="Vista ampliada con zoom" 
                                />
                            </TransformComponent>
                        </TransformWrapper>
                        {/* 👆 FIN DEL COMPONENTE DE ZOOM 👆 */}
