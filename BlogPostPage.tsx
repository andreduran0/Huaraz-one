...
const BlogCard: React.FC<{ post: any }> = ({ post }) => {
  // Función para extraer el ID de YouTube desde el link de Supabase para la miniatura
  ...
  return (
    <article className="space-y-8 animate-fadeIn group/card">
      ...
      <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200 aspect-video bg-slate-100 border border-slate-50">
        {post.video_url ? (
          /* Si hay video_url en Supabase, mostramos el iFrame real directamente */
          <iframe
            src={post.video_url}
          ...
          /* Si no hay video, mostramos la imagen destacada */
